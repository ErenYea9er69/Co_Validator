          ...
          <div className="max-w-2xl mx-auto glass-card animate-fade-in shadow-2xl shadow-purple-500/10">
            ...
            <form onSubmit={startInterrogation} className="space-y-6">
              ...
              <button type="button" onClick={() => setIdea({
                name: 'FitMentor AI', 
                problem: 'Personal trainers cost $60-150/hour, making personalized fitness coaching inaccessible to 90% of gym-goers. Most people follow generic YouTube workouts that don\'t adapt to their injuries, goals, or progress. They plateau within 3 months and quit due to lack of adaptive programming and poor form leading to minor injuries.',
                solution: 'AI-powered personal training app that creates adaptive workout plans using computer vision form analysis. Key features: (1) Real-time form correction via smartphone camera, (2) Progressive overload auto-adjustment, (3) Injury-aware exercise substitution, (4) Weekly plan adaptation based on recovery metrics.',
                industry: 'HealthTech',
                targetAudience: 'Gym-goers aged 22-40 who spend $30-80/mo on gym memberships but can\'t afford a personal trainer. Highly motivated but lack deep biomechanical knowledge.',
                monetization: 'Freemium model. Free tier: basic workout logging. Premium $14.99/mo: AI form analysis + adaptive plans. Target LTV is $90. Target CAC is $20.',
                competitorsInfo: 'Fitbod (algorithmic workout generator, but no computer vision/form analysis), Future ($150/mo human coach, too expensive for mass market), Tempo (requires $400+ proprietary hardware). Gap: No app provides real-time form correction using a standard smartphone camera at a consumer price.',
                stage: 'pre-revenue',
                founderBackground: 'Solo founder. 6 years as a Senior ML Engineer specializing in computer vision (former Meta AR team); also a certified NASM personal trainer.',
                budget: '$25,000 self-funded for MVP development. Runway is 6 months.',
                locale: 'North America (primarily USA)',
                whyNow: 'Advancements in lightweight mobile Computer Vision models (YOLOv8) finally allow for real-time 30-fps form correction on edge devices without huge cloud GPU overhead. Gym attendance is recovering post-COVID, but inflation makes humans too expensive.',
                tractionEvidence: 'Interviewed 45 gym-goers; 28 said they would pay $15/mo to avoid the $100/hr cost of a PT. Built a landing page with 1,200 waitlist signups in 3 weeks. Ran a Wizard-of-Oz pilot with 10 beta testers manually reviewing their video form with positive feedback.',
                targetPricing: '$14.99/mo subscription with 70% gross margin.',
                acquisitionChannel: 'Organic TikTok/Instagram Reels analyzing bad form in gym fails vs correct form (content marketing). Secondary: Micro-influencer sponsorships with niche fitness creators.',
                coFounders: 'None (Solo founder, heavily relying on AI coding assistants).',
                tractionDocs: 'Waitlist analytics: 1,200 emails, CAC of $1.50 per email via Meta Ads testing. 40% open rate on the welcome sequence. Pilot feedback: 8/10 testers said they would be "very disappointed" if the product disappeared.',
